...
export const removeUserChanged = () => api()?.removeUserChanged?.()
export const onNavigateToSession = (cb) => api()?.onNavigateToSession?.(cb)
export const removeOnNavigateToSession = () => api()?.removeOnNavigateToSession?.()
