...
const MODEL_MAPPING = {
    openai: {
        ...
        max: [
            { id: 'o1', name: 'O1 (Raisonnement avancé)', cost: 'high' },
    ...
    anthropic: {
        ...
        max: [
            { id: 'claude-3-7-sonnet-20250219', name: 'Claude 3.7 Sonnet (Dernière version)', cost: 'high' },
    ...
    gemini: {
        ...
        max: [
            { id: 'gemini-2.5-pro-exp', name: 'Gemini 2.5 Pro (Expérimental)', cost: 'high' },
