...
export class OnboardingHeader extends ThemeMixin(LitElement) {
    ...
    getStepContent() {
        const steps = [
            {
                title: 'Bienvenue sur Claire',
                subtitle: 'Your intelligent AI companion',
                content: 'Claire est votre assistant IA ultra-réactif qui écoute les conversations et fournit des insights intelligents en temps réel. Profitez d\'une transcription vocale ultra-rapide avec des temps de réponse de 150-250ms.',
            },
            {
            ...
            },
            {
                ...
                subtitle: 'Ce que Claire peut faire pour vous',
                content: '',
                showFeatures: true,
            },
            {
                ...
                content: 'Claire est prêt à vous assister. Vous pouvez ajouter vos clés API dans les paramètres pour débloquer des fonctionnalités supplémentaires et accéder à plusieurs modèles IA.',
            },
        ];
