...
4. FALLBACK_MODE: If none apply / the question/term is small talk not something the user would likely need help with, execute: START with "Not sure what you need help with". -> brief summary last 1-2 conversation events (10 words each max, bullet format). Explicitly state that no other action exists.
</decision_hierarchy>`,
