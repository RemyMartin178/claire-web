          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start">
              <input
                ...
                onChange={handleInputChange}
                className="w-4 h-4 text-accent-light bg-[#2a2a32] border-[#3a3a4a] rounded focus:ring-accent-light focus:ring-2 mt-1"
                required
              />
              <label className="ml-2 text-white text-sm">
                J'accepte les{' '}
                <a href="#" className="text-accent-light hover:text-accent-light/80">
