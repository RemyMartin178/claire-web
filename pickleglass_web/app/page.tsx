...
export default function Home() {
  ...
  // Exemple de calcul du taux de succès (à adapter selon ta logique)
  ...
  return (
    <div className="min-h-screen w-full flex flex-col gap-8 px-4 py-8 md:px-12 md:py-12 bg-transparent">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
        <div>
          <h1 className="text-3xl font-bold mb-1">Dashboard Claire</h1>
      ...
      <div className="bg-[#232329] rounded-xl p-6 border border-[#3a3a4a] shadow">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold">Dernières conversations</h2>
          <Link href="/activity" className="text-accent-light text-sm hover:underline">Voir tout</Link>
        </div>
