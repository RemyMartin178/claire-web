...
export function LiquidGlassInput({
    ...
    return (
        <div className={cn("relative group w-full", containerClassName)}>
            ...
            <div className="absolute inset-0 z-0 h-full w-full rounded-2xl transform-gpu
          ...
          transition-[box-shadow,transform] duration-240 ease-apple group-focus-within:shadow-[0_0_12px_rgba(0,0,0,0.04),0_8px_24px_rgba(0,0,0,0.08),inset_2px_2px_0.5px_-2px_rgba(0,0,0,0.4),inset_-2px_-2px_0.5px_-2px_rgba(0,0,0,0.3)]" />
            ...
            <div className="relative z-10 flex items-center w-full gap-2.5 px-3.5 py-1.5">
                ...
                <div className="flex items-center gap-1.5 pr-1">
                    <button className="p-2 rounded-full hover:bg-black/5 text-[#86868b] transform-gpu transition-[background-color,color,transform] duration-180 ease-apple active:scale-95">
